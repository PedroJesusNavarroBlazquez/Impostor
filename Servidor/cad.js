...
function Cad() {
    ...
    this.connect = function (callback) {
        var cad = this;
        //mongodb+srv://impostorP:1234@cluster0.wfcpa.mongodb.net/impostorpn?retryWrites=true&w=majority
        mongo.connect("mongodb+srv://impostorP:1234@cluster0.wfcpa.mongodb.net/impostorpn?retryWrites=true&w=majority", { useUnifiedTopology: true }, function (err, database) {
            if (err) {
